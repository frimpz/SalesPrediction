...
for i in range(start_point, end_point):  # actually this should be range(214200)
    ...
    if y == True:
        ...
        if df_test != 0:
            ...
            sales_34month_month_sorted['date_block_num'] = pd.to_datetime(sales_34month_month_sorted['date_block_num'],
                                                                          unit='m')
    ...
    print('The predicted value for Group ID {Group_ID} ({Shop}, {Item}) is {predicted}'.format(Group_ID=i, Shop=shop_no,
                                                                                               Item=item_no,
                                                                                               predicted=yhat_print))
